...
// Function to get a random hieroglyph
function getRandomHieroglyph() {
  // Get the children of the first item in the array (in this case, "A: Man and his Activities")
  const children = hieroglyphs[0].children;

  // Get a random index from the children array
  const randomIndex = Math.floor(Math.random() * children.length);

  // Get the random hieroglyph
  const randomHieroglyph = children[randomIndex];

  println(`You offer a prayer to Thoth and Seshat for guidance in your studies. 
  
  They tell a cryptic message:`);
...
const disk = () => ({
  ...
  rooms: [
    {
      id: 'entrance',
      name: 'Sacred Temple of Scribes',
      desc: `Welcome to the **SACRED TEMPLE OF SCRIBES**, blessed by Thoth and Seshat! 
      
      The limestone walls are covered in pristine hieroglyphics, showcasing the divine art you shall learn. A grand **STONE_DESK** stands before you, laden with fresh papyrus and reed pens.
      
      Type **HELP** to seek guidance from the gods.`,
      
      onLook: () => {
        const room = getRoom('entrance');
        room.desc = `The air is thick with the scent of fresh ink. Your **MASTER_SCRIBE** stands watchfully by the **STONE_DESK**, ready to teach you the sacred arts of mathematics, record-keeping, and hieroglyphics.
        
        The walls remind you that only the most dedicated can master these divine symbols.`;
      },
      
      items: [
        {
          name: ['stone desk', 'desk', 'stone_desk'],
          desc: `This limestone desk bears the marks of thousands of students before you. Mathematical calculations, tax records, and religious texts cover its surface.`,
        },
        {
          name: ['papyrus scroll', 'scroll', 'papyrus'],
          desc: `A pristine scroll of papyrus lies before you, its surface perfectly prepared for writing. Complex hieroglyphic exercises are visible on nearby completed scrolls.`,
          block: `The sacred texts require years of study before you may write them.`,
        },
        {
          name: ['reed pen', 'pen', 'writing tool'],
          desc: `A finely cut reed pen, the essential tool of your future profession. With this, you shall record the kingdom's taxes, religious texts, and royal decrees.`,
          isTakeable: true,
          onTake: () => println(`You carefully take the reed pen, knowing it will be your constant companion in the years of study ahead. You notice you can **STUDY**`),
          onUse: () => println(`You dip the reed pen in the inkwell and practice writing the sacred symbols on your papyrus scroll.`)

        }
      ],
      
      exits: [
        {dir: 'north', id: 'study_hall'},
      ],
    },
    {
      id: 'study_hall',
      name: 'Hall of Sacred Learning',
      desc: `The grand Hall of Learning stretches before you. **STUDENT_SCRIBES** sit in ordered rows, practicing their calculations and hieroglyphics.
      
      The walls display the 700 sacred signs you must memorize. To the **EAST** lies the Tax Records Chamber, and to the **WEST** is the Mathematical Studies Room.`,
      
      items: [
        {
          name: 'hieroglyphic tablet',
          desc: `A limestone tablet covered in practice hieroglyphics. The complex symbols remind you why scribal training takes many years to master.`,
        }
      ],
      
      exits: [
        {dir: 'east', id: 'tax_chamber'},
        {dir: 'west', id: 'math_room'},
        {dir: 'south', id: 'entrance'}
      ],
    },
    {
      id: 'tax_chamber',
      name: 'Chamber of Royal Records',
      desc: `This chamber holds the kingdom's tax records. Scrolls line the walls, containing meticulous accounts of grain, cattle, and gold.
      
      Here, you will learn to record the lifeblood of Egypt's economy.`,
      
      exits: [
        {dir: 'west', id: 'study_hall'}
      ],
    },
    {
      id: 'math_room',
      name: 'Chamber of Divine Mathematics',
      desc: `Numbers and calculations cover every surface. Here, future scribes learn the mathematics needed for architecture, astronomy, and tax collection.
      
      The presence of Thoth, god of wisdom, feels especially strong here. You notice you can **PRAY** to him.`,
      
      exits: [
        {dir: 'east', id: 'study_hall'}
      ],
    }
  ],
  ...
  characters: [
    {
      name: ['Master Scribe', 'teacher', 'master', 'scribe'],
      roomId: 'entrance',
      desc: 'The Master Scribe stands tall in pristine white linen, his eyes sharp from decades of precise writing.',
      onTalk: () => println(`"Welcome to the sacred path of the scribe. Are you prepared for years of rigorous study?"`),
      topics: [
        {
          option: 'Tell me about **TRAINING**',
          line: `"The path of the scribe is demanding. You must master 700 hieroglyphic signs, complex mathematics, and tax records. Few are chosen, fewer succeed, but those who do join the ranks of Egypt's most respected officials."`,
        },
        {
          option: 'What about **MATHEMATICS**?',
          line: `"A scribe must calculate taxes, measure fields, and plan monuments. Our mathematics serves both practical needs and divine harmony. You will learn addition, subtraction, multiplication, and fractions."`,
        },
        {
          option: 'Why are **HIEROGLYPHICS** so complex?',
          line: `"The sacred writing is deliberately complex. It separates the educated from the common people and ensures only the worthy can record our kingdom's most important matters. Each symbol must be perfect, for they carry divine power."`,
        }
      ]
    }
  ]
...
// Maintain existing command structure and add Egyptian-themed custom commands
commands[0] = Object.assign(commands[0], {
  pray: () => getRandomHieroglyph(),
  study: () => println(`You focus intently on the hieroglyphics before you, slowly learning their sacred meanings. You learn nothing.`)
});
const secretgame = () => ({
    roomId: 'entrance',
    rooms: [
        {
            id: 'entrance',
            name: 'Entrance',
            desc: `It seems I have been gone for some time, this is unrecognizable. I should probably **GO NORTH** through this archway.
            
            Actually, I should probably **LOOK** around first. Ther might be some nice **ITEMS**.
            
            Or mabye I need some **HELP**?`,
            items: [
                {
                    name: ['sword'],
                    desc: `A sword is stuck in a stone. It looks like it could be useful.`,
                    block: `I can't seem to lift it. Mabye I'm not the one?`,
                    onLook: () => {
                        const room = getRoom('entrance');
                        room.desc = `The sword is still stuck in the stone. I look at the cryptic symbols
                        只有我可以拿起这把剑
                        Is that a button?`

                        room.items.push({
                            name: ['button'],
                            desc: `The button is made of stone and is covered in ivy. It is on the sword's 5th letter.`,
                            onUse() {
                                const room = getRoom('entrance');
                                room.desc = `The sword is still stuck in the stone. I look at the cryptic symbols
                                只有我可以拿起这把剑
                                The sword is now free!`
                                room.items = room.items.filter(item => item.name !== 'sword');
                                room.items.push({
                                    name: ['sword'],
                                    desc: `The sword is now free!`,
                                    isTakeable: true,
                                    onTake: () => println(`You carefully take the sword, knowing it will be your constant companion in the years of study ahead.`),
                                    onUse() {
                                        if (room.id === 'entrance') {
                                            println(`You slash the sword through the air, feeling its power.`);
                                        
                                        }    
                                        else if (room.id === 'battle') {
                                            println(`You slash the sword through the battle, fleeing through to the door.`);
                                        }
                                    }
                                });
                            }
                ...
                },
                {
                    ...
                    desc: `The archway is made of stone and is covered in ivy. It towers over me. I can only see darkness beyond it.`
        ...
        },
        {
            id: 'battle',
            name: 'Battle',
            desc: `I can hear the sound of swords clashing and the smell of blood. I should probably **LOOK** around first. Ther might be some nice **ITEMS**. The **EXIT** to the south has collapsed before you.`,
            items: [
                {
                    name: ['door', 'exit'], 
                    desc: `The door is made of stone and is covered in ivy. It is to far away and gaurds protect it.`,
                    onUse() {
                        const battle = getRoom('battle');
                        const exit = getExit('east', battle.exits);
                        if (exit.block) {
                          println(`It's to far away.`);
                        } else {
                          goDir('east');
                        }                    
                    }
            ...
            exits: [
                {dir: 'east', id: 'hallway', block: `The gaurds stare me down.`},
                {dir: 'west', id: 'hell'},
            ],
        },
        {
            id: 'hallway',
            name: 'Hallway',
            desc: `The hallway is made of stone and is covered in ivy. It is dimly lit and the walls are covered in ivy. I should probably **LOOK** around first. Ther might be some nice **ITEMS**. The **EXIT** to the south has collapsed before you.`,
            items: [],
            exits: [
                {dir: 'east', id: 'library'},
                {dir: 'west', id: 'battle'},
        ...
        {
            id: 'hell',
            desc: `You know, you could have just stayed there, but instead you decided to jump into battle and die? Pathetic.
            Well, your journey ends here. Don't you dare **DECIEVE** me.`,
            items: [
                {
                    name: 'Stop looking!',
                    desc: `Stop looking!`
            ...
            exits: [
                {dir: 'east', id: 'secretgame', block: `The gaurd is gaurding it.`}
            ],
        },
        {
            id: 'secretgame',
            name: 'Secret Game',
            desc: `mabweb.vercel.app`
        }
    ]
    }
    );
...
commands[0] = Object.assign(commands[0], {
    decieve: () => {
        if (roomId == 'hell') {
            println(`You decieve the gaurd and he shows you the exit on acident.`);
            const exit = getExit('east', getRoom('hell').exits);
            delete exit.block;
            goDir('east');
        } else {
            println(`You can't decieve me.`);
        }
},
});
